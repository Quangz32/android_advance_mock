...
//    private int currentPosition;
    ...
    public MovieAdapter(List<Movie> movies, List<Movie> favoriteMovies, boolean favoriteMode) {
        this.movies = movies;
...
//    }
    ...
    public class MovieViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Movie movie, int position) {
            ...
            isFavorite = isFavoriteMovie(movie, favoriteMovies);
            ...
            binding.imgStar.setOnClickListener(v->{
                if(callback != null){
                    callback.onStarClicked(movie, position, isFavorite);
                }
...
//    }
    ...
    private boolean isFavoriteMovie(Movie movie, List<Movie> argFavoriteMovies) {
        if (favoriteMode) return true;
        if (argFavoriteMovies == null) return false;

        for (Movie favoriteMovie : argFavoriteMovies) {
    ...
    public interface MovieItemCallback {
        ...
        void onStarClicked(Movie movie, int position, boolean isFavorite);
    }
}